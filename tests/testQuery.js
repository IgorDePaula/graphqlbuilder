...
test('query completa',t=>{
  t.is(builderType('book',{id:'1',name:"igor"}) +' '+ retornaParametros(['name',{'author':['address','cellphone']}]),'book (id:"1",name:"igor") {name, author {address,cellphone}}')
})
